<template>
	<div class="pesquisadores">
		<div class="pesquisadores__cabecalho">
			<h1 class="pesquisadores__titulo">Orientandos</h1>
			<p class="pesquisadores__descricao">
				Todos os orientandos já cadastrados no sistema estão listados aqui, eles podem ser
				visualizados por outros usuários e utilizados na criação de outros projetos de
			...
			<div class="pesquisadores__busca">
				<CampoDeTexto
					...
					texto-auxiliar="Buscar orientandos..."
				/>
				<Button
